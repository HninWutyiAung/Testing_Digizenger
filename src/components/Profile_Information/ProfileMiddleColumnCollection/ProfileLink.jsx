...
const ProfileLink = () => {
  return (
    <div className="top-[3.1rem] z-20">
      <div
        className="w-full bg-white border-t border-[#ecf1f4] justify-start items-center gap-2 inline-flex
                            "
      >
        <div className="rounded-lg flex-col justify-center items-start gap-1 inline-flex pl-3 pt-1">
          <div className="justify-start items-center gap-2 inline-flex">
            <div
              className="text-[#2c3e50] font-bold font-['DM Sans']
                                        text-xs
                                        sm:text-sm
                                        md:text-sm
                                        lg:text-base
          ...
          <div className="justify-center items-center gap-2.5 inline-flex">
            <div
              className="text-[#7e7e8d] font-normal font-['DM Sans']
                                        text-xs
                                        sm:text-sm
                                        md:text-sm
                                        lg:text-base
