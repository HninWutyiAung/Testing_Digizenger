...
const Featured = () => {
    ...
    const checkScrollPosition = () => {
        ...
        if (container) {
            ...
            setCanScrollRight(container.scrollLeft < maxScrollLeft - 1);  // Ensure there's no rounding issue at the end
        }
    };
                ...
                <div className="self-stretch h-auto p-4 bg-white rounded-lg border border-solid border-[#c9dcde] flex-col justify-start items-start gap-2.5 flex">
                    <div className="self-stretch w-[394px] flex-col justify-start items-center gap-5 flex">
                        ...
                        <div className="w-[238px] h-7 px-6 py-3 rounded-lg justify-center items-center gap-2.5 flex">
                            <button className="text-[#8C8CA1] text-[16px] font-bold font-['DM Sans']">See all featured items</button>
                        </div>
                    </div>
                </div>
            </section>
