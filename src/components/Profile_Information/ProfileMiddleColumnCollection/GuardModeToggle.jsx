    ...
    <div className="bg-white z-20 ">
      ...
      >
        <div className="justify-start items-center gap-2 flex">
          <div className="text-[#2c3e50] text-sm font-bold font-['DM Sans'] sm:text-xs md:text-sm lg:text-base xl:text-base">
            Guard Mode
          </div>
          <div
            className={`w-10 h-5 sm:w-[35px] sm:h-[18px] md:w-[38px] md:h-[19px] lg:w-[40px] lg:h-[20px] relative flex items-center cursor-pointer rounded-full shadow-inner transition-colors duration-300 ${
              isGuardModeOn ? "bg-[#00BCD4]" : "bg-[#c9dcde]"
            }`}
            onClick={handleToggle}
          >
            <div
              className={`w-4 h-4 sm:w-[14px] sm:h-[14px] md:w-[15px] md:h-[15px] lg:w-[16px] lg:h-[16px] absolute top-[2px] rounded-full bg-white transition-transform duration-300 ease-in-out ${
                isGuardModeOn ? "translate-x-[22px]" : "translate-x-[2px]"
              }`}
            ></div>
          </div>
        </div>
