...
const OtherProfileAbout = () => {
  ...
  const {
    careerHistoryDtoList: careerHistory = [],
    serviceProvidedDtoList: servicesProvided = [],
    educationHistoryDtoList: educationHistory = [],
        ...
        <div className="h-auto self-stretch p-2 rounded border border-solid border-[#ECF1F4] flex-col justify-start items-start gap-2 flex">
          ...
          <div className="w-full h-auto flex flex-wrap gap-2">
            {servicesProvided.map((service, index) => (
              <div
                key={index}
                className="px-2 py-1 bg-[#ECF1F4] rounded-full flex items-center"
              >
...
export default OtherProfileAbout;
