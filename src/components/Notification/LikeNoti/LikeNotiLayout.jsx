...
function LikeNotiLayout (){
    ...
    return(
        <div className="flex flex-col items-start self-stretch px-[10px]">
                ...
                <div className='flex flex-col self-stretch w-full'>
                    <div className='flex justify-between self-stretch items-end '>
                        <div className='text-[14px] text-darkBlue leading-6 '>
                            ...
                            <span className='font-normal'>loved your post</span>
                        </div>
            ...
            <div className='self-stretch h-[2px] bg-accent'></div>
        </div>
    )
}
